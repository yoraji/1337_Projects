...
/*   Updated: 2025/03/16 22:55:30 by yoraji           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char	*ft_line(char *ptr)
{
	...
	if (!line)
		return (NULL);
	ft_strncpy_(line, ptr, len + added);
	line[len + added] = '\0';
	return (line);
}
